...
export default function MultilingualChatbot() {
    ...
    if (!chatState.isOpen) {
      ...
      setTimeout(() => {
        ...
        const welcomeMessage =
          welcomeMessages[chatState.currentLanguage.code as keyof typeof welcomeMessages] || welcomeMessages.en
  ...
  const simulateBotResponse = async (userMessage: string) => {
    ...
    if (isConnectedToHuman) {
      ...
      const langResponses =
        humanResponses[chatState.currentLanguage.code as keyof typeof humanResponses] || humanResponses.en
      ...
      const botResponses = {
        en: {
          ...
          shipping: "We offer standard (5-7 days) and express (2-3 days) shipping. Cash on delivery is also available.",
          hours:
        ...
        hi: {
          greeting: "नमस्ते! मैं आपकी मदद के लिए यहाँ हूँ। आज मैं आपकी कैसे सहायता कर सकता हूँ?",
          order: "मैं आपके ऑर्डर को ट्रैक करने में मदद कर सकता हूँ। कृपया अपना ऑर्डर नंबर दें और मैं इसे देखूंगा।",
          payment: "हम सभी प्रमुख क्रेडिट कार्ड, UPI, PayPal, और बैंक ट्रांसफर स्वीकार करते हैं। क्या कोई विशिष्ट भुगतान समस्या है?",
          return:
          ...
          shipping: "हम मानक (5-7 दिन) और एक्सप्रेस (2-3 दिन) शिपिंग प्रदान करते हैं। कैश ऑन डिलीवरी भी उपलब्ध है।",
          hours:
        ...
        bn: {
          greeting: "হ্যালো! আমি আপনাকে সাহায্য করার জন্য এখানে আছি। আজ আমি আপনাকে কীভাবে সহায়তা করতে পারি?",
          order: "আমি আপনার অর্ডার ট্র্যাক করতে সাহায্য করতে পারি। অনুগ্রহ করে আপনার অর্ডার নম্বর দিন এবং আমি এটি দেখব।",
          payment: "আমরা সমস্ত প্রধান ক্রেডিট কার্ড, UPI, PayPal, এবং ব্যাংক ট্রান্সফার গ্রহণ করি। কোনো নির্দিষ্ট পেমেন্ট সমস্যা আছে কি?",
          return:
          ...
          shipping: "আমরা স্ট্যান্ডার্ড (5-7 দিন) এবং এক্সপ্রেস (2-3 দিন) শিপিং অফার করি। ক্যাশ অন ডেলিভারিও উপলব্ধ।",
          hours:
        ...
        te: {
          greeting: "హలో! నేను మీకు సహాయం చేయడానికి ఇక్కడ ఉన్నాను. ఈరోజు నేను మీకు ఎలా సహాయం చేయగలను?",
          order: "నేను మీ ఆర్డర్‌ను ట్రాక్ చేయడంలో సహాయం చేయగలను. దయచేసి మీ ఆర్డర్ నంబర్ ఇవ్వండి మరియు నేను దానిని చూస్తాను.",
          payment: "మేము అన్ని ప్రధాన క్రెడిట్ కార్డులు, UPI, PayPal, మరియు బ్యాంక్ బదిలీలను అంగీకరిస్తాము. ఏదైనా నిర్దిష్ట చెల్లింపు సమస్య ఉందా?",
          return: "మా రిటర్న్ పాలసీ కొనుగోలు తర్వాత 30 రోజులలో రిటర్న్‌లను అనుమతిస్తుంది. మీ కోసం రిటర్న్ ప్రక్రియను ప్రారంభించాలని మీరు అనుకుంటున్నారా?",
          shipping: "మేము స్టాండర్డ్ (5-7 రోజులు) మరియు ఎక్స్‌ప్రెస్ (2-3 రోజులు) షిప్పింగ్ అందిస్తాము. క్యాష్ ఆన్ డెలివరీ కూడా అందుబాటులో ఉంది.",
          hours:
        ...
        mr: {
          greeting: "नमस्कार! मी तुमची मदत करण्यासाठी इथे आहे. आज मी तुमची कशी मदत करू शकतो?",
          order: "मी तुमचा ऑर्डर ट्रॅक करण्यात मदत करू शकतो. कृपया तुमचा ऑर्डर नंबर द्या आणि मी तो पाहीन.",
          payment: "आम्ही सर्व प्रमुख क्रेडिट कार्ड, UPI, PayPal, आणि बँक ट्रान्सफर स्वीकारतो. काही विशिष्ट पेमेंट समस्या आहे का?",
          return:
          ...
          shipping: "आम्ही स्टँडर्ड (5-7 दिवस) आणि एक्सप्रेस (2-3 दिवस) शिपिंग ऑफर करतो. कॅश ऑन डिलिव्हरी देखील उपलब्ध आहे.",
          hours:
        ...
        ta: {
          greeting: "வணக்கம்! நான் உங்களுக்கு உதவ இங்கே இருக்கிறேன். இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்?",
          order: "உங்கள் ஆர்டரை கண்காணிக்க நான் உதவ முடியும். தயவுசெய்து உங்கள் ஆர்டர் எண்ணைக் கொடுங்கள், நான் அதைப் பார்ப்பேன்.",
          payment:
        ...
        gu: {
          greeting: "નમસ્તે! હું તમારી મદદ કરવા માટે અહીં છું. આજે હું તમારી કેવી રીતે મદદ કરી શકું?",
          order: "હું તમારા ઓર્ડરને ટ્રેક કરવામાં મદદ કરી શકું છું. કૃપા કરીને તમારો ઓર્ડર નંબર આપો અને હું તેને જોઈશ.",
          payment: "અમે બધા મુખ્ય ક્રેડિટ કાર્ડ, UPI, PayPal, અને બેંક ટ્રાન્સફર સ્વીકારીએ છીએ. કોઈ ચોક્કસ પેમેન્ટ સમસ્યા છે?",
          return:
            "અમારી રિટર્ન પોલિસી ખરીદીના 30 દિવસમાં રિટર્નની મંજૂરી આપે છે. તમે ઇચ્છો છો કે હું તમારા માટે રિટર્ન પ્રક્રિયા શરૂ કરું?",
          shipping: "અમે સ્ટાન્ડર્ડ (5-7 દિવસ) અને એક્સપ્રેસ (2-3 દિવસ) શિપિંગ ઓફર કરીએ છીએ. કેશ ઓન ડિલિવરી પણ ઉપલબ્ધ છે.",
          hours:
        ...
        kn: {
          greeting: "ನಮಸ್ಕಾರ! ನಾನು ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ಇಲ್ಲಿದ್ದೇನೆ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?",
          order: "ನಿಮ್ಮ ಆರ್ಡರ್ ಅನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಲು ನಾನು ಸಹಾಯ ಮಾಡಬಹುದು. ದಯವಿಟ್ಟು ನಿಮ್ಮ ಆರ್ಡರ್ ಸಂಖ್ಯೆಯನ್ನು ನೀಡಿ ಮತ್ತು ನಾನು ಅದನ್ನು ನೋಡುತ್ತೇನೆ.",
          payment:
          ...
          return: "ನಮ್ಮ ರಿಟರ್ನ್ ನೀತಿಯು ಖರೀದಿಯ 30 ದಿನಗಳಲ್ಲಿ ರಿಟರ್ನ್‌ಗಳನ್ನು ಅನುಮತಿಸುತ್ತದೆ. ನಿಮಗಾಗಿ ರಿಟರ್ನ್ ಪ್ರಕ್ರಿಯೆಯನ್ನು ಪ್ರಾರಂಭಿಸಬೇಕೆಂದು ನೀವು ಬಯಸುತ್ತೀರಾ?",
          shipping: "ನಾವು ಸ್ಟ್ಯಾಂಡರ್ಡ್ (5-7 ದಿನಗಳು) ಮತ್ತು ಎಕ್ಸ್‌ಪ್ರೆಸ್ (2-3 ದಿನಗಳು) ಶಿಪ್ಪಿಂಗ್ ಅನ್ನು ನೀಡುತ್ತೇವೆ. ಕ್ಯಾಶ್ ಆನ್ ಡೆಲಿವರಿ ಕೂಡ ಲಭ್ಯವಿದೆ.",
          hours: "ನಮ್ಮ ಗ್ರಾಹಕ ಸೇವೆಯು ಈ ಚಾಟ್ ಮೂಲಕ 24/7 ಲಭ್ಯವಿದೆ. ನಮ್ಮ ಫೋನ್ ಬೆಂಬಲವು ಸೋಮವಾರ-ಶುಕ್ರವಾರ ಬೆಳಿಗ್ಗೆ 9 ರಿಂದ ಸಂಜೆ 6 ರವರೆಗೆ ಲಭ್ಯವಿದೆ.",
          default: [
        ...
        ml: {
          greeting: "നമസ്കാരം! നിങ്ങളെ സഹായിക്കാൻ ഞാൻ ഇവിടെയുണ്ട്. ഇന്ന് എനിക്ക് നിങ്ങളെ എങ്ങനെ സഹായിക്കാൻ കഴിയും?",
          order: "നിങ്ങളുടെ ഓർഡർ ട്രാക്ക് ചെയ്യാൻ എനിക്ക് സഹായിക്കാൻ കഴിയും. ദയവായി നിങ്ങളുടെ ഓർഡർ നമ്പർ നൽകുക, ഞാൻ അത് നോക്കാം.",
          payment:
          ...
          shipping: "ഞങ്ങൾ സ്റ്റാൻഡേർഡ് (5-7 ദിവസം) ഒപ്പം എക്സ്പ്രസ് (2-3 ദിവസം) ഷിപ്പിംഗ് വാഗ്ദാനം ചെയ്യുന്നു. ക്യാഷ് ഓൺ ഡെലിവറിയും ലഭ്യമാണ്.",
          hours:
        ...
        pa: {
          greeting: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਤੁਹਾਡੀ ਮਦਦ ਕਰਨ ਲਈ ਇੱਥੇ ਹਾਂ। ਅੱਜ ਮੈਂ ਤੁਹਾਡੀ ਕਿਵੇਂ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ?",
          order: "ਮੈਂ ਤੁਹਾਡੇ ਆਰਡਰ ਨੂੰ ਟਰੈਕ ਕਰਨ ਵਿੱਚ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ। ਕਿਰਪਾ ਕਰਕੇ ਆਪਣਾ ਆਰਡਰ ਨੰਬਰ ਦਿਓ ਅਤੇ ਮੈਂ ਇਸਨੂੰ ਦੇਖਾਂਗਾ।",
          payment: "ਅਸੀਂ ਸਾਰੇ ਮੁੱਖ ਕ੍ਰੈਡਿਟ ਕਾਰਡ, UPI, PayPal, ਅਤੇ ਬੈਂਕ ਟ੍ਰਾਂਸਫਰ ਸਵੀਕਾਰ ਕਰਦੇ ਹਾਂ। ਕੀ ਕੋਈ ਖਾਸ ਭੁਗਤਾਨ ਸਮੱਸਿਆ ਹੈ?",
          return:
          ...
          shipping: "ਅਸੀਂ ਸਟੈਂਡਰਡ (5-7 ਦਿਨ) ਅਤੇ ਐਕਸਪ੍ਰੈਸ (2-3 ਦਿਨ) ਸ਼ਿਪਿੰਗ ਦੀ ਪੇਸ਼ਕਸ਼ ਕਰਦੇ ਹਾਂ। ਕੈਸ਼ ਆਨ ਡਿਲੀਵਰੀ ਵੀ ਉਪਲਬਧ ਹੈ।",
          hours: "ਸਾਡੀ ਗਾਹਕ ਸੇਵਾ ਇਸ ਚੈਟ ਰਾਹੀਂ 24/7 ਉਪਲਬਧ ਹੈ। ਸਾਡਾ ਫੋਨ ਸਪੋਰਟ ਸੋਮਵਾਰ-ਸ਼ੁੱਕਰਵਾਰ ਸਵੇਰੇ 9 ਤੋਂ ਸ਼ਾਮ 6 ਤੱਕ ਉਪਲਬਧ ਹੈ।",
          default: [
        ...
        or: {
          greeting: "ନମସ୍କାର! ମୁଁ ଆପଣଙ୍କୁ ସାହାଯ୍ୟ କରିବା ପାଇଁ ଏଠାରେ ଅଛି। ଆଜି ମୁଁ ଆପଣଙ୍କୁ କିପରି ସାହାଯ୍ୟ କରିପାରିବି?",
          order: "ମୁଁ ଆପଣଙ୍କର ଅର୍ଡର ଟ୍ରାକ କରିବାରେ ସାହାଯ୍ୟ କରିପାରିବି। ଦୟାକରି ଆପଣଙ୍କର ଅର୍ଡର ନମ୍ବର ଦିଅନ୍ତୁ ଏବଂ ମୁଁ ଏହାକୁ ଦେଖିବି।",
          payment: "ଆମେ ସମସ୍ତ ମୁଖ୍ୟ କ୍ରେଡିଟ କାର୍ଡ, UPI, PayPal, ଏବଂ ବ୍ୟାଙ୍କ ଟ୍ରାନ୍ସଫର ଗ୍ରହଣ କରୁ। କୌଣସି ନିର୍ଦ୍ଦିଷ୍ଟ ପେମେଣ୍ଟ ସମସ୍ୟା ଅଛି କି?",
          return: "ଆମର ରିଟର୍ନ ନୀତି କ୍ରୟର 30 ଦିନ ମଧ୍ୟରେ ରିଟର୍ନକୁ ଅନୁମତି ଦିଏ। ଆପଣ ଚାହାଁନ୍ତି କି ମୁଁ ଆପଣଙ୍କ ପାଇଁ ରିଟର୍ନ ପ୍ରକ୍ରିୟା ଆରମ୍ଭ କରିବି?",
          shipping: "ଆମେ ଷ୍ଟାଣ୍ଡାର୍ଡ (5-7 ଦିନ) ଏବଂ ଏକ୍ସପ୍ରେସ (2-3 ଦିନ) ସିପିଂ ପ୍ରଦାନ କରୁ। କ୍ୟାସ ଅନ ଡେଲିଭରି ମଧ୍ୟ ଉପଲବ୍ଧ।",
          hours: "ଆମର କଷ୍ଟମର ସେବା ଏହି ଚାଟ ମାଧ୍ୟମରେ 24/7 ଉପଲବ୍ଧ। ଆମର ଫୋନ ସପୋର୍ଟ ସୋମବାର-ଶୁକ୍ରବାର ସକାଳ 9ଟାରୁ ସନ୍ଧ୍ୟା 6ଟା ପର୍ଯ୍ୟନ୍ତ ଉପଲବ୍ଧ।",
          default: [
        ...
        as: {
          greeting: "নমস্কাৰ! মই আপোনাক সহায় কৰিবলৈ ইয়াত আছো। আজি মই আপোনাক কেনেকৈ সহায় কৰিব পাৰো?",
          order: "মই আপোনাৰ অৰ্ডাৰ ট্ৰেক কৰাত সহায় কৰিব পাৰো। অনুগ্ৰহ কৰি আপোনাৰ অৰ্ডাৰ নম্বৰ দিয়ক আৰু মই ইয়াক চাম।",
          payment: "আমি সকলো মুখ্য ক্ৰেডিট কাৰ্ড, UPI, PayPal, আৰু বেংক ট্ৰান্সফাৰ গ্ৰহণ কৰো। কোনো নিৰ্দিষ্ট পেমেণ্ট সমস্যা আছে নেকি?",
          return:
          ...
          shipping: "আমি ষ্টেণ্ডাৰ্ড (5-7 দিন) আৰু এক্সপ্ৰেছ (2-3 দিন) শ্বিপিং আগবঢ়াওঁ। কেশ্ব অন ডেলিভাৰীও উপলব্ধ।",
          hours:
      ...
      const currentBotResponses =
        botResponses[chatState.currentLanguage.code as keyof typeof botResponses] || botResponses.en
      ...
      if (
        ...
        response = currentBotResponses.default[Math.floor(Math.random() * currentBotResponses.default.length)]
      }
    }
  ...
  return (
    <>
      ...
      <div className="fixed bottom-24 right-6 z-50 w-96 max-w-[calc(100vw-3rem)] animate-in slide-in-from-bottom-4 duration-300">
        <Card className="flex flex-col h-[600px] max-h-[80vh] shadow-xl border-0 overflow-hidden bg-white">
          {/* Header */}
